...
(function dartProgram() {
  ...
  H = {JS_CONST: function JS_CONST() {
    ...
    fillLiteralMap: function(keyValuePairs, result) {
      ...
      for (t1 = H._instanceType(result), t2 = t1._precomputed1, t1 = t1.__rti$_rest[1], index = 0; index < $length;) {
        index0 = index + 1;
  ...
  N = {
    main: function(args) {
      var responses, t1, response_index,
        randomNumberGenerator = new P._Random();
      randomNumberGenerator._Random$1(1000 * Date.now());
      responses = H._asString(C.Map_JoJeh.$index(0, args.length < 1 ? H._asString(C.Map_sggkc.$index(0, randomNumberGenerator.nextInt$1(3))) : args[0])).split("\n");
      t1 = responses.length;
      response_index = randomNumberGenerator.nextInt$1(t1);
      if (response_index >= t1)
        return H.ioore(responses, response_index);
      H.printString(responses[response_index]);
    }
  };
  var holders = [C, H, J, P, N];
  ...
  H.ConstantStringMap.prototype = {
    ...
    forEach$1: function(_, f) {
      ...
      keys = this._keys;
      for (t2 = keys.length, t1 = t1.__rti$_rest[1], i = 0; i < t2; ++i) {
        key = keys[i];
  ...
  H.GeneralConstantMap.prototype = {
    _getMap$0: function() {
      ...
      if (backingMap == null) {
        t1 = _this.$ti;
        backingMap = new H.JsLinkedHashMap(t1._eval$1("@<1>")._bind$1(t1.__rti$_rest[1])._eval$1("JsLinkedHashMap<1,2>"));
  ...
  (function inheritance() {
    ...
    _inheritMany(P.Object, [H.JS_CONST, J.Interceptor, J.ArrayIterator, P.Error, H.ConstantMap, H.Closure, P.MapMixin, H.LinkedHashMapCell, H.Rti, H._FunctionParameters, P.Null, P.StringBuffer, P._Random]);
  ...
  H._Universe_addRules(init.typeUniverse, JSON.parse('{"JSBool":{"bool":[]},"JSArray":{"List":["1"],"Iterable":["1"]},"JSUnmodifiableArray":{"JSArray":["1"],"List":["1"],"Iterable":["1"]},"JSNumber":{"num":[]},"JSInt":{"int":[],"num":[]},"JSNumNotInt":{"num":[]},"JSString":{"String":[]},"ConstantStringMap":{"ConstantMap":["1","2"]},"GeneralConstantMap":{"ConstantMap":["1","2"]},"JsLinkedHashMap":{"MapMixin":["1","2"]},"MapBase":{"MapMixin":["1","2"]}}'));
  ...
  return s.substring(8, s.length - 1);
    ...
    C.List_positive_neutral_negative = H.setRuntimeTypeInfo(makeConstList(["positive", "neutral", "negative"]), type$.JSArray_dynamic);
    C.Map_JoJeh = new H.ConstantStringMap(3, {positive: "It is certain\nWithout a doubt\nYou may rely on it\nYes definitely\nIt is decidedly so\nAs I see it, yes\nMost likely\nYes\nOutlook good\nSigns point to yes", neutral: "Reply hazy try again\nBetter not tell you now\nAsk again later\nCannot predict now\nConcentrate and ask again", negative: "Don\u2019t count on it\nOutlook not so good\nMy sources say no\nVery doubtful\nMy reply is no"}, C.List_positive_neutral_negative, H.findType("ConstantStringMap<@,@>"));
    C.Map_sggkc = new H.GeneralConstantMap([0, "negative", 1, "neutral", 2, "positive"], H.findType("GeneralConstantMap<@,@>"));
  })();
